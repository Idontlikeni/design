...
<body>
    ...
    <div class="container">
        ...
        <form id="contact" action="send_answer.php" method="post">
            ...
            <h4>Текст ответа</h4>
            <fieldset>
                <input placeholder="Текст ответа" type="text" tabindex="1" name="name" id="quest" value="Японский язык"
                    required autofocus>
            </fieldset>
                                ...
                                <div class="xpandable-block<?php echo $group->id?>">
                                    <div class="tab">
                                        <table class="table_blur">
                                            <tbody>
                                                <tr>
                                                    <th colspan="2" style="background:#FB8C00" ><label class="labeltable" for="button<?php echo $group->id?>" style="color:#fff"><?php echo $group->name?></label></th>
                                                </tr>
